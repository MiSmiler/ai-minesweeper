...
| --- | --- | --- |
| `--seed <seed>` | Pin one Seed — a plain `u32` — for every game in this server run: each Difficulty reproduces the same Mine layout. Absent, every New Game draws a fresh random Seed, printed to the terminal. | random |
